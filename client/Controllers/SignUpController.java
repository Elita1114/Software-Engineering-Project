...
public class SignUpController {
    ...
    void signUp(ActionEvent event) {
    	...
    	String I_D = removeSpaces(IDText.getText());
    ...
    private void checkInput(String passwd, String passValidate, String user_name, String I_D, String cardNumber, 
    		String phoneNumber, String email) throws IOException {
    	...
    	if(!passwd.equals(passValidate))
    		error_message += "Your enterd passwords are not equal\n";
  
    	if(I_D.length()!=9)
    		error_message += "Your ID length isn't 9\n";
    	
    	if(cardNumber.length()<11 || cardNumber.length()>19)
    		error_message += "Your card number length isn't right\n";
    	
    	if(phoneNumber.length()!=10 || phoneNumber.length()!=12) // Israeli
    		error_message += "Your phone number length isn't right\n";
    ...
    public String removeNonNumbers(String str){
    	String temp = "";
